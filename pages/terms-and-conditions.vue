<template>
  <div class="section z-3 privacy-policy">
    ...
    <p>
      ...
      carefully before using <a href="/">https://stavrosliaskos.com/</a> website
      (the "Service") operated by Stavros Liaskos.
    </p>
    ...
    <p>
      ...
      Service. This Terms and Conditions agreement for Stavros Liaskos is
      powered by
    ...
    <p>
      My Service may contain links to third-party web sites or services that are
      not owned or controlled by Stavros Liaskos.
    </p>
    <p>
      Stavros Liaskos has no control over, and assumes no responsibility for,
      the content, privacy policies, or practices of any third party web sites
      or services. You further acknowledge and agree that Stavros Liaskos shall
    ...
    <p>
      ...
      Berlin, Germany, without regard to its conflict of law provisions.
    </p>
    ...
    <p>
      ...
      agreement between me regarding our Service, and supersede and replace any
      prior agreements I might have between us regarding the Service.
    </p>
    ...
    <h4>Contact Me</h4>
    <p>
      If you have any questions about these Terms, you may contact me at one of
      my social profiles.
    </p>
  </div>
</template>
